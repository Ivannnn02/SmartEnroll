    ...
    <head>
        <meta charset="UTF-8">
        <title>AMI Nexus | Enrollment</title>
    ...
    <header class="enroll-header">
        <div class="header-left">
            <img src="assets/logoo.png" alt="AMI Nexus Logo">
...
<form id="enrollmentForm" action="save_enrollment.php" method="POST">
    ...
    <div class="form-top">
        <a href="index.php" class="icon-back" title="Go Back">
    ...
    <input type="date" id="completionDate" name="completion_date">
        ...
        <section class="form-section">
            ...
            <div class="ch-grid">
                ...
                <label><input type="radio" name="grade_level" value="Grade 4"> Grade 4</label>
                <label><input type="radio" name="grade_level" value="Grade 5"> Grade 5</label>
                <label><input type="radio" name="grade_level" value="Grade 6"> Grade 6</label>
            </div>
        </section>
        ...
        <section class="form-section">
            ...
            <div class="form-grid four">
                <div class="form-group">
                    ...
                    <input type="text" name="learner_lname">

                </div>

                <div class="form-group">
                    <label>First Name</label>
                    <input type="text" name="learner_fname">

                </div>

                <div class="form-group">
                    <label>Middle Name</label>
                    <input type="text" name="learner_mname">
    ...
    <section class="form-section">
        <h2>C. PARENT / GUARDIAN INFORMATION</h2>
...
<div id="successPopup" class="popup-overlay">
  ...
  <div class="popup-box">
    ...
    <div class="popup-icon success-icon" id="successIcon">
        <img src="assets/logoo.png" id="successLogo" alt="Logo">
...
<div id="validationPopup" class="popup-overlay">
  ...
  <div class="popup-box">
    ...
    <div class="popup-icon" id="popupIcon">
        <img src="assets/logoo.png" id="popupLogo" alt="Logo">
