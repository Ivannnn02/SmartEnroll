        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            // When user clicks display field → open date picker
        ...
        /* SHOW POPUP WITH LOGO → X ANIMATION */
        function showValidationPopup() {
            ...
            // After short delay → morph into X
            setTimeout(() => {
    ...
    submitBtn.addEventListener("click", () => {
        ...
        // 2️⃣ Grade level radio validation
        if (!document.querySelector('input[name="grade_level"]:checked')) valid = false;
        ...
        // 5️⃣ Medication field validation
        if (medsYes.checked && !medsInput.value.trim()) {
            medsInput.classList.add("input-error");
        ...
        // ✅ All validations pass → show confirmation summary
        buildSummary();
        summaryModal.style.display = "flex";
    });
    ...
    function showInlineError(input, message) {
        ...
        function showSuccessPopup() {
            ...
            // After delay → morph logo into check
            setTimeout(() => {
